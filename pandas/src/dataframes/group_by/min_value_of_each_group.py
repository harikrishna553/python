...
min_ele_in_each_group = group_by_city.min()
print('\nType of min_ele_in_each_group : ', type(min_ele_in_each_group))
print('\nData in min_ele_in_each_group is : ')
print(min_ele_in_each_group)