...
# Perform Right Join and select specific columns to avoid duplication
result_df = df1.join(df2, "dept_id", "right").select(df1.id, df1.name, df2.dept_id, df2.dept_name)
